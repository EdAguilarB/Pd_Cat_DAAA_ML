...
class reaction_graph(Dataset):
    ...
    def __init__(
        self, opt: argparse.Namespace, filename: str, mol_cols: list, root: str
    ) -> None:
    ...
    def get(self, idx):
        ...
        molecule = torch.load(os.path.join(self.processed_dir, f"reaction_{idx}.pt"))
        return molecule
